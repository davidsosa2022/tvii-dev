...
?>
  ...
  <menu class="menu-buttons">
    ...
    <a data-hover navi_target data-hover-sound="SE_MOVEPAGE_SELECT" href="javascript:void(0);" class="before_page_button accesskey-l accesskey-zl"></a>
...
<a data-hover navi_target href="javascript:void(0)" data-sound="SE_WAVE_OK_SUB" class="post-button"><?php echo localize("vino.program.olv.viewer.post-button") ?></a>
