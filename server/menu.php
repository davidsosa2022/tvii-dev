...
<div class="menu-tab">
    <div class="search-section">
     ...
     <a href="javascript:void(0)" navi_mouse data-hover data-hover-out-sound="SE_CMN_TOUCH_CANCEL" data-hover-sound="SE_CMN_TOUCH_ON" navi_target class="search-options" data-sound="SE_A_DECIDE_TOUCH_OFF">TV Tag Room</a>
  </div>
  ...
  <ul>
    <li>
     ...
     <div class="pin-ask">
      ...
      <span class="pin-input" data-sound="SE_OPEN_TEXT">Please input your PIN...</span>
