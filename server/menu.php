...
<div class="app-setting-selection-container">
  <a navi_mouse data-hover data-hover-out-sound="SE_CMN_TOUCH_CANCEL" data-hover-sound="SE_CMN_TOUCH_ON"  navi_target href="javascript:void(0)" class="setting-option pc">Parental Controls Settings</a>
  <a navi_mouse data-hover data-hover-out-sound="SE_CMN_TOUCH_CANCEL" data-hover-sound="SE_CMN_TOUCH_ON"  navi_target href="javascript:void(0)" class="setting-option mv">Miiverse Settings</a>
  <a navi_mouse data-hover data-hover-out-sound="SE_CMN_TOUCH_CANCEL" data-hover-sound="SE_CMN_TOUCH_ON"  navi_target href="javascript:void(0)" class="setting-option apd">Auto Power Down Settings</a>
  <a navi_mouse data-hover data-hover-out-sound="SE_CMN_TOUCH_CANCEL" data-hover-sound="SE_CMN_TOUCH_ON"  navi_target href="javascript:void(0)" class="setting-option other">Other Settings</a>
</div>
